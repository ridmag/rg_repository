...
public class Templates {
	...
	static {
		...
		dynamicReportsComponent = cmp.horizontalList(
				cmp.image(
						...
						.setFixedDimension(60, 60), cmp.verticalList(
						cmp.text("DynamicReports")
								.setStyle(bold22CenteredStyle)
								.setHorizontalAlignment(
										HorizontalAlignment.LEFT),
						cmp.text("http://dynamicreports.sourceforge.net")
	...
	public static ComponentBuilder<?, ?> createTitleComponent(String label) {
		...
		/*
		 * cmp.horizontalList() .add( dynamicReportsComponent,
		 * cmp.text(label).setStyle
		 * (bold18CenteredStyle).setHorizontalAlignment(HorizontalAlignment
		 * .RIGHT)) .newRow() .add(cmp.line()) .newRow()
