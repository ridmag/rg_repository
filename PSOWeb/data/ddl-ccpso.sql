...
-- Drop Core Tables
-- -----------------------------------------------------
DROP TABLE IF EXISTS CommunicationNotes cascade;
DROP TABLE IF EXISTS StudentSpecialNeedsXRef cascade;
DROP TABLE IF EXISTS StudentCommunicatonXref cascade;
DROP TABLE IF EXISTS StudentGuardians cascade;
DROP TABLE IF EXISTS StudentGuardiansXRef cascade;
DROP TABLE IF EXISTS Communications cascade;
DROP TABLE IF EXISTS communicationCategories cascade;
DROP TABLE IF EXISTS StudentFundingSources cascade;
DROP TABLE IF EXISTS studentevents cascade;
DROP TABLE IF EXISTS transactions cascade;
DROP TABLE IF EXISTS invoices cascade;
DROP TABLE IF EXISTS programevents cascade;
DROP TABLE IF EXISTS GroupedStudents cascade;
DROP TABLE IF EXISTS locations cascade;
DROP TABLE IF EXISTS StudentGroups cascade;
DROP TABLE IF EXISTS programs cascade;
DROP TABLE IF EXISTS programtypes cascade;
DROP TABLE IF EXISTS Leaves cascade;
drop table if exists fileData cascade;
DROP TABLE IF EXISTS StaffSkills cascade;
DROP TABLE IF EXISTS staffmembers cascade;
DROP TABLE IF EXISTS LeavePolicies cascade;
DROP TABLE IF EXISTS LeavePolicyDetails cascade;
DROP TABLE IF EXISTS stafftypes cascade;
DROP TABLE IF EXISTS students cascade;
DROP TABLE IF EXISTS authorities cascade;
DROP TABLE IF EXISTS users cascade;
DROP TABLE IF EXISTS externalOrganizations cascade;
...
DROP TABLE IF EXISTS StudentConsents cascade;
DROP TABLE IF EXISTS HoursUtilizedReportItem cascade;
DROP TABLE IF EXISTS HoursUtilizedReport cascade;
...
CREATE TABLE programevents (
  ...
  rosterstartTime timestamp with time zone NULL,
  rosterendTime timestamp with time zone NULL,
